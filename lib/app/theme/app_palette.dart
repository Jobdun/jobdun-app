...
class _Palette {
  ...
  static const slate450 = Color(0xFF8B98AB); // CUSTOM — gap-fill, dark text3 (5.0:1)
  static const slate500 = Color(0xFF64748B); // light text3
  static const slate550 = Color(0xFF708096); // CUSTOM — gap-fill, borderStrong (3.63:1)
  ...
  static const slate900 = Color(0xFF0F172A); // dark background / onAction / light text1
  ...
  static const orange550 = Color(0xFFEA6C0A); // CUSTOM — hand-tuned pressed (~12% darker)
  ...
  static const navy900 = Color(0xFF1E3A5F); // CUSTOM — desaturated info surface (dark availableBg)
  ...
  static const amber600 = Color(0xFFD97706); // light warning + light star (3:1 on white)
